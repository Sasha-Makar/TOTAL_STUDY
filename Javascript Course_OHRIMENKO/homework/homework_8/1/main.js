...
//Програма повинна брати інформацію з масиву об’єктів,де кожен об’єкт представляє
//книгу, і динамічно додавати її в HTML.
//Кроки для виконання завдання:
//1.Створити масив об’єктів, де кожен об’єкт представляє книгу:
//•Кожен об’єкт повинен містити наступні властивості: назва книги,
//автор,рік видання, жанр. (Приклад масиву наведено нижче)
//2.Створити HTML-структуру для виведення списку книг:
//•Додати контейнер (наприклад, <div id="bookList"></div>), в який буде
// додаватися інформація про книги.
//3.Написати функцію для динамічного виведення книг:
//•Функція повинна перебирати масив книг і для кожної книги створювати
//HTML-елемент (наприклад, <div>, <p>) із відповідною інформацією.
...
const library = {
    render(books, element) {
        books.forEach(book=>{
            ...
            h2.innerText = `Title:${book.title}. Author:${book.author}`;
            let p = document.createElement('p');
            p.innerText = `Year:${book.year}`;
            let pGenre = document.createElement('p');
            p.innerText = `Genre: ${book.genre}`;

            element.append(h2, p, pGenre);
        })
    },
}
